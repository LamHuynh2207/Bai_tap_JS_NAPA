 ...
 * tử mà req cần mình sẽ sử dụng settimeout và đưa element đó vào call back, call back đó sẽ được đưa vào web api để xử lý và sau 
 ...
 * task queue vào stack và thực hiện function từ đó ta sẽ có response của 3 request sẽ phản hồi với thời gian gần bằng nhau
 * 
 * code:
 */
